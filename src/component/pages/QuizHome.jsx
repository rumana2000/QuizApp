...
export default function QuizHome() {
  const { quizList, loading } = useQuizList()
  quizList.map((data, idx) => {
    console.log(data.quizCategoryId);
  })
    ...
    <>
      <div className="main">
        <div className="container mx-auto">
          ...
          {!loading && <>
            {quizList.length > 0 && <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-4  place-items-center">
